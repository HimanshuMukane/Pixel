...
! function(a) {
    var b = -1,
        ...
        e = function(a) { return parseFloat(a) || 0; };
    a.fn.matchHeight = function(b) { if ("remove" === b) { var c = this; return this.css("height", ""), a.each(a.fn.matchHeight._groups, function(a, b) { b.elements = b.elements.not(c); }), this; } return 1 >= this.length ? this : (b = "undefined" != typeof b ? b : !0, a.fn.matchHeight._groups.push({ elements: this, byRow: b }), a.fn.matchHeight._apply(this, b), this); }, a.fn.matchHeight._groups = [], a.fn.matchHeight._throttle = 80, a.fn.matchHeight._maintainScroll = !1, a.fn.matchHeight._apply = function(b, c) {
        var f = a(b),
            g = [f],
            h = a(window).scrollTop(),
            i = a("html").outerHeight(!0),
            j = f.parents().filter(":hidden");
        return j.css("display", "block"), c && (f.each(function() {
            var b = a(this),
                c = "inline-block" === b.css("display") ? "inline-block" : "block";
            b.data("style-cache", b.attr("style")), b.css({ display: c, "padding-top": "0", "padding-bottom": "0", "border-top-width": "0", "border-bottom-width": "0", height: "100px" });
        }), g = d(f), f.each(function() {
            var b = a(this);
            b.attr("style", b.data("style-cache") || "").css("height", "");
        })), a.each(g, function(b, d) {
            var f = a(d),
                g = 0;
            c && 1 >= f.length || (f.each(function() {
                var b = a(this),
                    c = "inline-block" === b.css("display") ? "inline-block" : "block";
                b.css({ display: c, height: "" }), b.outerHeight(!1) > g && (g = b.outerHeight(!1)), b.css("display", "");
            }), f.each(function() {
                var b = a(this),
                    c = 0;
        ...
        }), j.css("display", ""), a.fn.matchHeight._maintainScroll && a(window).scrollTop(h / i * a("html").outerHeight(!0)), this;
    ...
    var f = function() { a.each(a.fn.matchHeight._groups, function() { a.fn.matchHeight._apply(this.elements, this.byRow); }); };
    a.fn.matchHeight._update = function(d, e) {
        if (e && "resize" === e.type) {
            var g = a(window).width();
            if (g === b) return;
            b = g;
        }
        d ? -1 === c && (c = setTimeout(function() { f(), c = -1; }, a.fn.matchHeight._throttle)) : f();
    }, a(a.fn.matchHeight._applyDataApi), a(window).bind("load", function(b) { a.fn.matchHeight._update(); }), a(window).bind("resize orientationchange", function(b) { a.fn.matchHeight._update(!0, b); });
}(jQuery), jQuery(function(a) { a(window).load(function() { a(".match-height").matchHeight(); }); });
